...
public class MainWindowController implements Initializable {
	...
	public void handleMouseClick(MouseEvent arg0) {
		// System.out.println("clicked on " + arg0.getSource()+ "----------" +
		// listViewMainWindow.getSelectionModel().getSelectedItem());
		// //listViewMainWindow.getSelectionModel().getSelectedItem() daje ime grupe
